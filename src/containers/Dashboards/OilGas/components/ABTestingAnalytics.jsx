...
const ABTestingAnalytics = ({ t, dir, themeName }) => (
  <Panel md={12} lg={12} xl={12} title={t('OIL AND GAS MARKET REVIEW')}>
    <div dir="ltr">
      <ResponsiveContainer height={250} className="dashboard__area">
        <AreaChart data={data} margin={{ top: 20, left: -15, bottom: 20 }}>
          ...
          <Legend />
          <CartesianGrid />
          <Area name="Gasoline" type="monotone" dataKey="a" fill="#4ce1b6" stroke="#4ce1b6" fillOpacity={0.2} />
          
          <Area name="Kerosene" type="monotone" dataKey="d" fill="#70bbfd" stroke="#70bbfd" fillOpacity={0.2} />

          <Area name="Biodiessel" type="monotone" dataKey="b" fill="#038cfc" stroke="#038cfc" fillOpacity={0.2} />
          
          <Area name="Ethanol" type="monotone" dataKey="c" fill="#fc0f03" stroke="#fc0f03" fillOpacity={0.2} />
