  ...
  <Panel md={12} lg={7} xl={5} sm={12} xs={12} title={t('dashboard_commerce.sales_report')}>
    <div className="dashboard__sales-report">
      <div className="progress-wrap progress-wrap--small">
        ...
        <p className="dashboard__sales-report-now">298,92 Birr</p>
        <p className="dashboard__sales-report-plan">250 Birr planned</p>
      ...
      <div className="progress-wrap progress-wrap--small progress-wrap--pink">
        ...
        <p className="dashboard__sales-report-now">1423,01 Birr</p>
      ...
      <div className="progress-wrap progress-wrap--small progress-wrap--pink">
        ...
        <p className="dashboard__sales-report-now">44321,74 Birr</p>
        <p className="dashboard__sales-report-plan">45000 Birr planned</p>
        <p className="dashboard__sales-report-value progress__label">100%</p>
        <Progress value={87} />
      </div>
    </div>
