...
const NewCommodities = ({ t, newOrder, onDeleteRow }) => (
  <Panel
    xl={6}
    lg={16}
    md={16}
    title={t('International Commodity Price')}
  >
    <Table responsive striped className="dashboard__table-orders">
      <thead>
        <tr>
          <th>Karat</th>
          <th>Purity Level</th>
          <th>Price in USD/Gram</th>
          <th>Price in Birr/Gram</th>
...
NewCommodities.propTypes = {
  newOrder: NewOrderTableProps.isRequired,
  onDeleteRow: PropTypes.func.isRequired,
  t: PropTypes.func.isRequired,
};

export default withTranslation('common')(NewCommodities);
